package com.application.server.app.dao;


import com.application.server.app.dao.iface.IDao;
import com.application.server.app.dao.query.Query;
import com.application.server.app.dao.session.Session;
import com.application.server.app.dao.session.exception.SessionCommittedException;
