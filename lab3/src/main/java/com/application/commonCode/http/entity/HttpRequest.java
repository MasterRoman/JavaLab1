package com.application.commonCode.http.entity;

import com.application.commonCode.http.entity.specification.HttpMethod;
import com.application.commonCode.http.entity.specification.HttpVersion;
import com.application.commonCode.http.entity.specification.Specification;
import com.application.commonCode.http.entity.specification.exception.HttpException;
import com.application.commonCode.http.entity.specification.exception.request.BadRequest;
import com.application.commonCode.http.entity.specification.exception.request.HttpRequestException;
import com.application.commonCode.http.entity.specification.exception.request.HttpVersionNotSupported;
import com.application.commonCode.http.entity.specification.exception.request.MethodNotAllowed;
